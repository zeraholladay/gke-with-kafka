"""
Django settings for kafka_manager project.
...
SECRET_KEY = 'django-insecure-7pn7#u5a!7ep%tw+gtr1vp$8y271(i4z2_s8c7@q=^e$a$%km5'
...
INSTALLED_APPS = [
    ...
    'kafka_manager_app.apps.KafkaManagerAppConfig',
]
...
ROOT_URLCONF = 'kafka_manager.urls'
...
WSGI_APPLICATION = 'kafka_manager.wsgi.application'
